...
defineProps({
  product: Object,
  recommendations: Array, // produk rekomendasi
});
...
const buyNow = () => {
  alert(`Langsung beli ${product.name} (${quantity.value}x).`);
};
...
<template>
  ...
  <AuthenticatedLayout>
    ...
    <!-- Bagian Utama Produk -->
    <div
      class="tw-flex tw-flex-col md:tw-flex-row tw-bg-white tw-rounded-2xl tw-shadow-lg tw-overflow-hidden tw-p-8 tw-gap-8"
    >
      <!-- FOTO PRODUK -->
      <div class="md:tw-w-[40%] tw-flex tw-justify-center tw-items-start">
        <img
          ...
          alt="Product Image"
          class="tw-w-80 tw-h-80 tw-object-cover tw-rounded-xl tw-border tw-border-gray-200 tw-shadow-sm"
        />
      </div>
      ...
      <div class="md:tw-w-[60%] tw-space-y-5 tw-text-gray-800">
        ...
        <div class="tw-flex tw-items-center tw-gap-4 tw-mt-4">
          ...
          <div class="tw-flex tw-items-center tw-gap-2">
            ...
            <span class="tw-min-w-[2rem] tw-text-center tw-text-lg tw-font-medium">
              {{ quantity }}
            </span>
            <button
              @click="increaseQty"
        ...
        <div class="tw-flex tw-gap-5 tw-pt-5">
          <button
            @click="addToCart"
            class="tw-border tw-border-orange-500 tw-text-orange-500 tw-font-semibold tw-rounded-lg tw-px-6 tw-py-2.5 hover:tw-bg-orange-50 tw-transition tw-text-base"
          >
            Tambah ke Keranjang
          </button>
          ...
          <button
            @click="buyNow"
            class="tw-bg-orange-500 tw-text-white tw-font-semibold tw-rounded-lg tw-px-6 tw-py-2.5 hover:tw-brightness-110 tw-transition tw-text-base"
          >
            Beli Sekarang
          </button>
        </div>
    ...
    <div class="tw-mt-12">
      ...
      >
        ...
        >
          ...
          />
          <div class="tw-p-4">
            <h4 class="tw-font-semibold tw-text-blue-900 tw-text-lg tw-truncate">
              {{ rec.name }}
            </h4>
