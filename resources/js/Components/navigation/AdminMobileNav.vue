...
<template>
    <header class="tw-sticky tw-top-0 tw-z-40 tw-border-b tw-border-slate-200 tw-bg-white/95 tw-backdrop-blur md:tw-hidden">
        ...
        >
            <div class="tw-flex tw-h-full tw-flex-col tw-border-r tw-border-slate-200 tw-bg-white">
                <div class="tw-flex tw-items-center tw-justify-between tw-border-b tw-border-slate-200 tw-px-5 tw-pb-3 tw-pt-6">
                ...
                <nav class="tw-flex-1 tw-space-y-1 tw-overflow-y-auto tw-px-3 tw-pb-6 tw-pt-4">
                    <Link
                        v-for="link in links"
                        :key="link.name"
                        :href="link.href"
                ...
                <div class="tw-border-t tw-border-slate-200 tw-px-3 tw-py-4 tw-text-xs tw-text-slate-400">
                    © KopSy Campus
                </div>
            </div>
        </van-popup>
